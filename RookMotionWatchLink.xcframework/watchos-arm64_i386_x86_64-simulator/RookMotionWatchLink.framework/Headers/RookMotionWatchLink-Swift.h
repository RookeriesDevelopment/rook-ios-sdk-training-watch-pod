...
SWIFT_CLASS("_TtC19RookMotionWatchLink11OptionalInt")
...
SWIFT_CLASS("_TtC19RookMotionWatchLink9RMIndexes")
@interface RMIndexes : RealmSwiftObject
...
SWIFT_CLASS("_TtC19RookMotionWatchLink11RMSensorAPI")
...
SWIFT_CLASS("_TtC19RookMotionWatchLink6RMUser")
...
SWIFT_CLASS("_TtC19RookMotionWatchLink28RMUserPhysiologicalVariables")
...
@interface RWCommunicationManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface RWCommunicationManager (SWIFT_EXTENSION(RookMotionWatchLink)) <WCSessionDelegate>
...
SWIFT_CLASS("_TtC19RookMotionWatchLink22RWHeartRateDataRecords")
@interface RWHeartRateDataRecords : RealmSwiftObject
...
@interface RWHeartRateDataRecords (SWIFT_EXTENSION(RookMotionWatchLink))
...
SWIFT_CLASS("_TtC19RookMotionWatchLink17RWStepDataRecords")
@interface RWStepDataRecords : RealmSwiftObject
@property (nonatomic, copy) NSString * _Nonnull timestamp;
...
@interface RWStepDataRecords (SWIFT_EXTENSION(RookMotionWatchLink))
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end


SWIFT_CLASS("_TtC19RookMotionWatchLink16RWStorageManager")
@interface RWStorageManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end



@class RWTrainingSummaries;
@class RWTrainingStoragedRecords;

SWIFT_CLASS("_TtC19RookMotionWatchLink14RWTrainingInfo")
@interface RWTrainingInfo : RealmSwiftObject
...
@property (nonatomic, strong) RWAuxiliarSummary * _Nullable auxSummary;
...
SWIFT_CLASS("_TtC19RookMotionWatchLink25RWTrainingStoragedRecords")
@interface RWTrainingStoragedRecords : RealmSwiftObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC19RookMotionWatchLink17RWTrainingSummary")
@interface RWTrainingSummary : RealmSwiftObject
...
SWIFT_CLASS("_TtC19RookMotionWatchLink14RWTrainingType")
@interface RWTrainingType : RealmSwiftObject
@property (nonatomic, copy) NSString * _Nullable trainingTypeUUID;
...
SWIFT_CLASS("_TtC19RookMotionWatchLink8UseSteps")
